...
public class City extends TableImpl<CityRecord> {
     ...
     */
    public final TableField<CityRecord, String> NAME = createField(DSL.name("Name"), SQLDataType.CHAR(35).nullable(false).defaultValue(DSL.inline("", SQLDataType.CHAR)), this, "");

    /**
     * The column <code>world.city.CountryCode</code>.
     */
    public final TableField<CityRecord, String> COUNTRYCODE = createField(DSL.name("CountryCode"), SQLDataType.CHAR(3).nullable(false).defaultValue(DSL.inline("", SQLDataType.CHAR)), this, "");

    /**
     * The column <code>world.city.District</code>.
     */
    public final TableField<CityRecord, String> DISTRICT = createField(DSL.name("District"), SQLDataType.CHAR(20).nullable(false).defaultValue(DSL.inline("", SQLDataType.CHAR)), this, "");

    /**
     * The column <code>world.city.Population</code>.
     */
    public final TableField<CityRecord, Integer> POPULATION = createField(DSL.name("Population"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.inline("0", SQLDataType.INTEGER)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.CITY_COUNTRYCODE);
    }
    ...
    public List<ForeignKey<CityRecord, ?>> getReferences() {
        return Arrays.asList(Keys.CITY_IBFK_1);
    }
    ...
    public Country.CountryPath country() {
        if (_country == null)
            _country = new Country.CountryPath(this, Keys.CITY_IBFK_1, null);
